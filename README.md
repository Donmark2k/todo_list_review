...
**[To do list review]**  is used to request review from my coding partner to see if the issues that I created in [todo_list](https://github.com/Donmark2k/todo_list/issues) will the same as the required that will be pointed out by my coding partner.
...
- [Live Demo Link](https://donmark2k.github.io/todo_list_review/dist/)
...
https://github.com/Donmark2k/todo_list_review.git
...
- cd my-folder
-  git clone https://github.com/Donmark2k/todo_list_review.git
